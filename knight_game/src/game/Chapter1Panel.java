  ...
  public Chapter1Panel(Character character) {
    ...
    buttons[0].addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        HomePanel.fadeout(bgPanel, new InGamePanel(character, new Stage1().getMonsters(), backgroundImage), frame);
      }
    });
    ...
    buttons[1].addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        JButton a = (JButton) e.getSource();
        JFrame frame = (JFrame) a.getTopLevelAncestor();
        HomePanel.fadeout(bgPanel, new InGamePanel(character, new Stage2().getMonsters(), backgroundImage), frame);
      }
    });
    ...
    buttons[2].addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        JButton a = (JButton) e.getSource();
        JFrame frame = (JFrame) a.getTopLevelAncestor();
        HomePanel.fadeout(bgPanel, new InGamePanel(character, new Stage3().getMonsters(), backgroundImage), frame);
      }
    });
